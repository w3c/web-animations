...
sudo pip install --user lxml || error_exit "Error installing pip libxml"
sudo pip install --user lxml --upgrade || error_exit "Error upgrading libxml"
sudo pip install --user pygments || error_exit "Error installing Pygments"
